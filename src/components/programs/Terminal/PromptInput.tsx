...
function PromptInput({ running, onTop: currentOnTop }: PromptInputProps) {
  const [prompt, setPrompt] = useState("");
  const [promptToExecute, setPromptToExecute] = useState<string | undefined>(
    undefined
  );
  ...
  useEffect(() => {
    ...
    setPromptToExecute(undefined);
    // Interpret against the program instance from this render.
